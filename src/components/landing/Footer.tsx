      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          <div className="space-y-8">
            <div className="flex flex-col leading-[0.8] items-start group">
              <span className="text-5xl font-black tracking-tighter text-white">
                DS
              </span>
              <span className="text-primary uppercase text-[14px] tracking-[0.25em] font-black">
                DESPACHANTE
              </span>
            </div>
          ...
          <div>
            <h4 className="font-black uppercase tracking-widest text-primary text-lg mb-10 italic">Navegação</h4>
            <ul className="space-y-6 text-zinc-300 font-bold uppercase text-[16px] tracking-widest">
              ...
              <li><Link href="/#faq" className="hover:text-primary transition-colors py-2 inline-block">Dúvidas</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="font-black uppercase tracking-widest text-primary text-lg mb-10 italic">Onde Estamos</h4>
            <ul className="space-y-10 text-zinc-300 font-bold text-xl md:text-2xl">
              <li className="flex gap-5 items-start leading-relaxed">
                ...
                <span>
                  ...
                  <span className="text-primary italic text-[14px] md:text-base uppercase tracking-wider font-black">(Em frente ao radar de 40 km/h)</span>
                </span>
              </li>
              <li className="flex gap-5 items-center text-primary font-black uppercase italic tracking-tighter text-3xl md:text-4xl mt-6">
          ...
          <div>
            <h4 className="font-black uppercase tracking-widest text-primary text-lg mb-10 italic">Atendimento</h4>
            <ul className="space-y-8 text-zinc-300 font-bold uppercase text-[16px] tracking-widest">
              <li className="flex flex-col gap-3">
                <span className="text-zinc-500 text-base">Segunda a Sexta</span>
                <span className="flex items-center gap-4 text-2xl"><Clock className="h-8 w-8 text-primary" /> 08:00 às 19:00</span>
              </li>
              <li className="flex flex-col gap-3">
                <span className="text-zinc-500 text-base">Sábados</span>
                <span className="flex items-center gap-4 text-2xl"><Clock className="h-8 w-8 text-primary" /> 09:00 às 15:00</span>
              </li>
            </ul>
          </div>
        </div>

        <div className="border-t border-zinc-900 pt-12 flex flex-col md:flex-row justify-between items-center gap-8 text-[14px] text-zinc-500 font-black uppercase tracking-[0.2em]">
